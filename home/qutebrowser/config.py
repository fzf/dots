...
config.bind('D', 'scroll left', mode='caret')
config.bind('H', 'scroll down', mode='caret')
config.bind('T', 'scroll up', mode='caret')
config.bind('N', 'scroll right', mode='caret')
...
config.bind('d', 'move-to-prev-char', mode='caret')
config.bind('h', 'move-to-next-line', mode='caret')
config.bind('t', 'move-to-prev-line', mode='caret')
config.bind('n', 'move-to-next-char', mode='caret')
...
config.bind('<Ctrl-H>', 'completion-item-focus --history next', mode='command')
...
config.bind('<Ctrl-T>', 'completion-item-focus --history prev', mode='command')
